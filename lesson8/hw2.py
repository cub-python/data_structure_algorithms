...
from collections import namedtuple     # воспользуемся функцией namedtuple из стандартной библиотеки
...
def main():
    s = input('Введите строку для кодировки: ')  # читаем строку длиной  до 10**4
